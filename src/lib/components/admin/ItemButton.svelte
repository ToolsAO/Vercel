            ...
            <div class="content p-8 pt-2 overflow-y-auto">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <!-- disabled currently till id is sorted -->
                        <select disabled bind:value={mainType} id="mainType" name="mainType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
